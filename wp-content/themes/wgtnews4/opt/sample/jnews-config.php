				...
				'fields'     => array(
					array(
			            ...
			            array(
							...
							'default'  => 'Add any text/something you need',
			            ),
						array(
							'id'       => 'switched-on',
							'type'     => 'switch',
...
//Weather forcast setup~~~~~~~~~~~~

Redux::set_section(
	$opt_name, array(
				'title'      => esc_html__( 'Weather Settings', 'your-textdomain-here' ),
				'id'         => 'weather_settings',
				'subsection' => true,
				'fields'     => array(
			            array(
							'id'       => 'city-name',
							'type'     => 'text',
							'title'    => esc_html__( 'City Name', 'your-textdomain-here' ),
							'subtitle' => esc_html__( 'Enter your City Name with keeping first letter Capital', 'your-textdomain-here' ),
						),
						array(
							'id'       => 'country-code',
							'type'     => 'text',
							'title'    => esc_html__( 'Country Code', 'your-textdomain-here' ),
							'subtitle' => esc_html__( 'Enter your Country Code in capital', 'your-textdomain-here' ),
						),
					)
			)
);
