...
// ======================================================
// Rightside Latest News Posts widget ~~~~~~~~~~~~~
// ======================================================

add_action( 'widgets_init', 'latest_news_register_widgets' );
 
function latest_news_register_widgets() {
    register_widget( 'lst_news' );
}

class lst_news extends WP_Widget {
		                	...
		                	<ul class="container post-list">
							    <li class="row">
							    	<div class="img-container">
							    		<a href="<?php the_permalink(); ?>">
								        	<?php the_post_thumbnail('post-thumbnail', ['class' => 'attachment-thumbnail size-thumbnail wp-post-image', 'title' => 'Feature image']);?>
								        </a>
							    	</div>							        
							        <div class="text-container">
							        	<a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
							            <br><i class="fa fa-clock-o" aria-hidden="true"></i> <?php the_time( 'F jS, Y' ); ?>
							        </div>
							    </li>
							</ul>
		                    <?php 
...
add_action( 'widgets_init', 'recnt_posts_widget_thumb' );
 
function recnt_posts_widget_thumb() {
    register_widget( 'recnt_posts_widget' );
}

class recnt_posts_widget extends WP_Widget {
 
    function __construct() {

    	// To show the title of widget in admin area 
        parent::__construct(
            'recent_posts_widget_thumbnails',  // Base ID
            'Recent Posts Widget with Thumbnails'   // Name
        ); 
    }
                                ...
                                <div class="post postCount post-count-large mb-4">
                                    ...
                                    <div class="post-content my-3 ">
                                        <div class="post-title">
                                            ...
                                            <div class="dt-time">
                                            	<i class="fa fa-clock-o" aria-hidden="true"></i> <?php the_time( 'F jS, Y' ); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
